...
namespace Panosen.CodeDom.Typescript.Engine
{
    ...
    {
        private void GenerateForStep(ForStep forStepBuilder, CodeWriter codeWriter, GenerateOptions options)
        {
            ...
            GenerateStepOrCollectionListAsBlock(forStepBuilder.Steps, codeWriter, options);
        }
    }
}
